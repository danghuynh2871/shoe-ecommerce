  ...
  <div class="product-management">
    ...
    <div v-if="showModal" class="modal-overlay">
      <div class="modal">
        ...
        <button @click="deleteProduct">Xóa</button>
        <button @click="closeModal">Không</button>
      </div>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      ...
      products: [
        {
          id: 'SP001',
          image: require('@/assets/backgroundLogin.jpg'), // Ensure the path is correct
          name: 'Nike Air Max',
          price: '2,999,000đ',
          stock: 50,
          size: '39, 40, 41, 42',
      ...
      productIdToDelete: null // New data property to store the product ID to delete
    }
  },
  computed: {
    filteredProducts() {
